...
<body class="back">
			...
			<div class="offcanvas offcanvas-end" tabindex="-1"
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
						...
						<li class="nav-item"><a class="nav-link" href="to-do.jsp">To-Do</a></li>
	...
	<div class="container container1 mt-5 bg-gradient">
		...
		<table
			...
			<tr>
			<% List<User> list=(ArrayList<User>)hs.getAttribute("adminDoing");
  ...
  <%    }
    	 ...
    	 for(User item:list){
    		 java.util.Date date=new java.util.Date();
    			...
    			<td><a href="delete?email=<%=item.getEmail()%>"><button class="btn btn-danger">Remove</button></a></td>
    			</tr>
    			<%    }
     }
	%>
